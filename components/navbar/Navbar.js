...
export const Navbar = props => {
    const {showPanel, getPanel, getSheets, showSheets, theme} = useContext(NavbarContext)

  return (
    <header className={`${styles.navbar} ${theme === "black" && styles.darkTheme}`}>
      <div
        className={`${styles.headerOfSheets}`}
      >
        {!showPanel ? (
          <button
