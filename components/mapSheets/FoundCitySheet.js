        ...
        {typeOfMap === 2 ? (
          <>
            <span className={styles.showOnTransportSheetHeader}>
              ...
              <div>
                <p>При нажатии на любую точку на карте программа рассчитывает: <br/>
                  1. 5-минутную доступность<br/>
                  2. 10-минутную доступность<br/>
                  3. 15-минутную доступность<br/>
                </p>
              </div>
            </span>
              ...
              <>
                <div>
                  ...
                  <ToggleButton
                    ...
                    checked={objToggles['objects_zdrav']}
                ...
                <div>
                  ...
                  <ToggleButton
                    ...
                    id={'objects_education'}
                    handleToggleChange={handleToggleChange}
                    checked={objToggles['objects_education']}
                ...
                <div>
                  ...
                  <ToggleButton
                    ...
                    id={'objects_tourism'}
                    handleToggleChange={handleToggleChange}
                    checked={objToggles['objects_tourism']}
                ...
                {haveZdrav && (
                  <div>
                    ...
                    <ToggleButton
                      ...
                      handleToggleChange={handleToggleChange}
                      checked={
                        objToggles['hex_zdrav'] || objToggles['objects_zdrav']
                      }
                      className={toggleStyles.zdrav}
                    />
                  </div>
