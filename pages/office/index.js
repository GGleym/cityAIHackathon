...
import {
  ...
  officeReducer,
  ACTIONS
} from '../../functions/officeReducer';
import inputStyles from '/styles/Input.module.css';
import { formatNumber } from '../../functions/formatNumber';
import { getFMS } from '../../functions/getFMS';
import AsyncSelect from 'react-select/async';
import { formatDate } from '../../functions/formatDate';
import {handleSeriesChange} from "../../functions/handleSeriesChange";
import {handleNumberPassportChange} from "../../functions/handleNumberPassportChange";
              ...
              <>
                ...
                <div className={styles.showMoreSection}>
                  ...
                  <InputType
                      ...
                      name={'birthday'}
                  />
                  <div className={`${styles.issuedByInput} ${inputStyles.inputBox}`}>
                    <AsyncSelect
                        inputId={"select"}
                        styles={{
                    ...
                    />
                    <label htmlFor="select" className={`${issuedBy ? `${inputStyles.inputFilled} ${inputStyles.inputBox}` : inputStyles.inputBox}`}>Кем выдан?</label>
                  </div>
                  <InputType
                ...
                <ShowMoreButton text={"Скрыть дополнительные данные"} onClick={() => setMore(!more)} svgStatus={more} />
                <AgreeSection />
                <ButtonSection />
              </>
          ) : (
              <>
                <ShowMoreButton text={"Показать дополнительные данные"} onClick={() => setMore(!more)} svgStatus={more} />
                <AgreeSection />
                <ButtonSection />
              </>
          )}
